                        ...
                        {['/images/test/car-test.webp', '/images/test/wat-test.jpg', '/images/test/wat-test2.jpg'].map((src, index) => (
                            <div className="embla__slide flex-[0_0_100%] min-w-0 relative h-[100vh] text-white" key={index}>
                                <div
                                    data-aos="fade-down"
                                    data-aos-delay="100"
                                    className='absolute w-full z-10 left-[70%] md:left-[50%] top-[50%] translate-[-50%] md:translate-x-[-50%] translate-x-[-80%]'
                                >
                                    <div className='text-white my-container'>
                                        <div className='px-[15%]'>
                                            <div className='text-[37px] font-bold max-w-[800px]'>
                                                <div className='inline text-brand pr-2'>
                                                    A growing network
                                                </div>
                                                <div className='inline'>
                                                    of companies dedicated
