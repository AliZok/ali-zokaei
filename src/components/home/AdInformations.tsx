                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <div className="">
                                <Image
                                    ...
                                    alt="Stores covered icon"
                                    width={50}
                                    height={50}
                                    className="w-[50px] h-auto befor-hover"
                                    quality={60}
                                />
                                <Image
                                    src="/images/house-white.png"
                                    alt="Stores covered white icon"
                                    width={50}
                                    height={50}
                                    className="w-[50px] h-auto after-hover"
                                    quality={60}
                                />
                            </div>
                        </div>
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <div className="">
                                ...
                                <Image
                                    ...
                                    alt="Cases delivered white icon"
                                    width={50}
                                    height={50}
                                    className="w-[50px] h-auto after-hover"
                                    quality={60}
